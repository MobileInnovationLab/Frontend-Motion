    ...
    <>
      ...
      {process.env.NEXT_PUBLIC_RECRUITMENT_CLOSED ? (
        <section className="flex flex-col items-center justify-center container mx-auto px-10 lg:px-[20rem] text-center my-20">
          ...
          <p className="text-[inter] text-[14px] lg:text-[18px] text-[#6A6A6A] mt-3">Open recruitment is now closed and we are no longer accepting more applicants. Thank you for your enthusiasm!</p>
        ...
        <>
          ...
          <section className="container mx-auto">
            <img src="/images/recruitment/register-hero.png" className="hidden lg:block w-1/3 mx-auto py-10" alt="Register Hero" />
          </section>
            ...
            <div className="bg-white rounded px-10 py-14 lg:mx-[10rem]">
              <form onSubmit={formik.handleSubmit}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 m-0 p-0 gap-x-10 my-8">
                  ...
                  <RecruitmentTextInputField label="Student Curriculum Vitae (CV)*" name="cv" placeholder="Link CV" onChange={formik.handleChange} error={formik.errors.cv} required suffix={<img src="/svg/link.svg" alt="link" />} />
                </div>
