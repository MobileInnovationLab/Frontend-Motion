    ...
    <div className="bg-[#FCF6F6]">
      ...
      <section ref={homeRef} className="w-full bg-[url('/images/recruitment/recruitment-landing-bg.png')] bg-cover bg-no-repeat bg-[center_bottom_0rem]">
        <div className="container w-full mx-auto flex justify-between flex-col lg:flex-row items-center pb-40 pt-32">
          ...
          <div className="w-2/3 h-auto lg:h-[30rem] pt-5 lg:pt-0">
            <img src="/images/recruitment/recruitment-landing.png" className="w-full h-full object-contain" alt="Recruitment Landing" />
          </div>
        </div>
      </section>
      ...
      <section ref={aboutRef}>
        ...
        <div className="flex flex-col lg:flex-row align-items-center mt-14 container justify-content-center m-auto">
          <div className="w-full h-[507px] bg-black rounded-lg me-10">
            <img src="/images/recruitment/internship-activities.png" className="object-cover w-full h-full rounded-lg" alt="Internship Activities" />
          </div>
      ...
      <section className="">
        ...
        <div className="mt-10 lg:mt-0">
          <img src="/images/recruitment/route-map.png" className="w-full object-cover" alt="Route Map" />
        </div>
      </section>
