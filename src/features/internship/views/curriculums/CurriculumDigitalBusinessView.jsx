...
import useCurriculumDigitalBussinessViewModel from "../../viewModels/useCurriculumDigitalBusinessViewModel";

const CurriculumDigitalBusinessView = () => {
  const { weeks, videoDetails, timeSince, weekVideos, weekTitles, setWeeks } =
    useCurriculumDigitalBussinessViewModel();

  const toggleWeek = (index) => {
    const updatedWeeks = weeks.map((isOpen, i) => (i === index ? !isOpen : isOpen));
