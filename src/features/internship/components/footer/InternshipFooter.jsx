...
import styles from "../../../../core/styles/components/footer.module.scss";
    ...
    <>
      <footer className={styles["footer-container"]}>
        ...
        <section className={styles["footer-column"]}>
          ...
          <div className={styles["footer-item"]}>
            ...
            <p>
              Telkom University Landmark Tower - 0624
        ...
        <section className={styles["footer-column"]}>
          ...
          <Link href="#requirement" legacyBehavior>
            <a className={`${styles["footer-item"]} ${styles["link"]}`}>
              Requirement
            </a>
          </Link>
        ...
        <section className={styles["footer-column"]}>
          ...
          <a
            ...
            target="_blank"
            className={`${styles["footer-item"]} ${styles["link"]}`}
          >
            <div className={styles["footer-item-img"]}>
              <Image
                src="/images/footer/footer-line.png"
                alt="Line Link"
                layout="fill"
                objectFit="cover"
          ...
          <a
            rel="noreferrer"
            href="https://www.linkedin.com/company/motion-laboratory/mycompany/"
            target="_blank"
            className={`${styles["footer-item"]} ${styles["link"]}`}
          >
            <div className={styles["footer-item-img"]}>
              <Image
                src="/images/footer/footer-linkedin.png"
                alt="Linkedin Link"
                layout="fill"
                objectFit="cover"
                className="footer-item-img"
          ...
          >
            <div className={styles["footer-item-img"]}>
              <Image
                src="/images/footer/footer-instagram.png"
                alt="Instagram Link"
                layout="fill"
                objectFit="cover"
              />
          ...
          <a
            rel="noreferrer"
            href="https://www.facebook.com/motionlab.telu"
            target="_blank"
            className={`${styles["footer-item"]} ${styles["link"]}`}
          >
            <div className={styles["footer-item-img"]}>
              <Image
                src="/images/footer/footer-facebook.png"
                alt="Facebook Link"
                layout="fill"
                objectFit="cover"
                className="footer-item-img"
      ...
      <footer className={styles["footer-copyright"]}>
        ...
        <p className={styles.copyright}>
          Copyright Mobile Innovation Laboratory 2023
        </p>
      </footer>
    </>
  );
