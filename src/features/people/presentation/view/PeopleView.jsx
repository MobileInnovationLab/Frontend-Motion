...
import { containerVariants, itemVariants, titleVariants, buttonVariants } from "../../constants/animations";

const PeopleView = () => {
  const { activeCategory, setActiveCategory, sortedGenerations, filteredMembers } = usePeople();
