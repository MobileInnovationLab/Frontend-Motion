      ...
      <section className="container mx-auto my-10">
        <div className="bg-white rounded px-10 py-14 lg:mx-[10rem]">
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 m-0 p-0 gap-x-10 my-8">
              <RecruitmentSelectInputField className="appearance-none mb-8 lg:mb-0" label="Major" name="major" placeholder="Choose major" onChange={formik.handleChange} error={formik.errors.major} suffix={<img src="/svg/arrow-down.svg" />} required>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 m-0 p-0 gap-x-10 my-8">
              <RecruitmentSelectInputField className="appearance-none mb-8 lg:mb-0" label="Division" name="division" placeholder="Choose division" onChange={formik.handleChange} error={formik.errors.division} suffix={<img src="/svg/arrow-down.svg" />} required>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 m-0 p-0 gap-x-10 my-8">
              <RecruitmentTextInputField className="mb-8 lg:mb-0" label="Portfolio" name="portfolio" placeholder="Link Portfolio" onChange={formik.handleChange} error={formik.errors.portfolio} required suffix={<img src="/svg/link.svg" />} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 m-0 p-0 gap-x-10 my-8">
              <RecruitmentTextInputField className="mb-8 lg:mb-0" label="KSM" name="ksm" placeholder="Link KSM" onChange={formik.handleChange} error={formik.errors.ksm} required suffix={<img src="/svg/link.svg" />} />
