...
const page = () => {
  return (
    <div className="bg-[#FCF6F6]">
      ...
      <section className="w-full bg-[url('/recruitment/recruitment-landing-bg.png')] bg-cover bg-no-repeat bg-[center_bottom_0rem]">
        <div className="container w-full mx-auto flex justify-between flex-col lg:flex-row items-center pb-40 pt-32">
          ...
          <div className="w-2/3 h-auto lg:h-[30rem] pt-5 lg:pt-0">
            <img
              src="/recruitment/recruitment-landing.png"
      ...
      <section>
        <h3 className="text-center font-[rubik] text-red-500 text-[18px]">
          ABOUT
        </h3>
        <h1 className="text-center font-[rubik] font-bold text-[48px]">
      ...
      <section className="">
        ...
        <div>
          <img
            src="/recruitment/route-map.png"
            className="w-full object-cover lg:relative lg:top-[-20rem]"
          />
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 mt-14">
          <div>
            <div className="flex border-[2px] border-[#332C2B] border-solid rounded-full bg-white">
              ...
              <p className="align-center font-semibold text-[12px] lg:text-[14px] text-[#6A6A6A] my-auto ms-5">
            ...
            <div className="h-[50px] px-10 my-2">
              <img
                src="/recruitment/requirement-line.png"
