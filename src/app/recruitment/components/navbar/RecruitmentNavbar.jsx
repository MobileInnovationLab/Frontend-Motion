...
const RecruitmentNavbar = ({ onNavigation }) => {
  ...
  function getNavClassName() {
    let className =
      "transition duration-300 text-center fixed m-auto left-0 right-0 py-5 z-10";
      ...
      >
        ...
        >
          ...
          <ul className="text-left container mx-auto">
            ...
            <li className="w-full">
              <button className="bg-[#332C2B] w-full text-white text-[inter] text-[16px] rounded-full py-4 hover:bg-opacity-90 transition duration-400">
                Join Us!
              </button>
            </li>
