    ...
    <div className={getCustomClassNameUtils("flex flex-col", className)}>
      ...
      <div className="flex relative">
        <div className="w-full">
          <input {...props} className="w-full bg-[#F6FAFD] border rounded-full border border-solid border-[#B9C0CD] focus:border-[#F82F1E] focus:outline-none py-3 px-6" type="text" placeholder={placeholder} name={name} />
