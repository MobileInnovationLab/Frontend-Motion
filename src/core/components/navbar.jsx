          ...
          <div className={styles["container"]}>
            <div className={styles["navbar-img-white"]}>
              <Link href="" passHref legacyBehavior>
                <Image src="/images/navbar/logo-white-transparent.png" alt="Motion Logo" layout="fill" objectFit="cover" />
              </Link>
            </div>
            <div className={styles["navbar-img-red"]}>
              <Link href="" passHref legacyBehavior>
                <Image src="/images/navbar/logo-red-transparent.png" alt="Motion Logo" layout="fill" objectFit="cover" />
              </Link>
            </div>
            ...
            <ul className={styles["nav-links"]}>
              {navs.map((nav) => (
                <li className={styles["style-hover"]} key={nav.text}>
                  {/* dropdown button */}
                  <a href={nav.href} className={`${styles["nav-item"]} ${styles[`${pathname == nav.href || nav?.dropDown?.find((navItem) => navItem.href == pathname) ? "active" : ""}`]}`}>
                    {nav.text}
                  </a>
                  {/* dropdown */}
                  {"dropDown" in nav && (
