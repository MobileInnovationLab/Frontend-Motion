            ...
            <ul className={styles["nav-links"]}>
              {navs.map((nav) => (
                <li className={styles["style-hover"]} key={nav.text}>
                  {/* dropdown button */}
                  <Link href={nav.href} className={`${styles["nav-item"]} ${styles[`${router.pathname == nav.href || nav?.dropDown?.find((navItem) => navItem.href == router.pathname) ? "active" : ""}`]}`}>
                    {nav.text}
                  </Link>
                  {/* dropdown */}
                  {"dropDown" in nav && (
                      ...
                      {nav.dropDown.map((navHover) => (
                        <>
                          <li key={`${navHover.text}-li`}>
                            <Link href={navHover.href}>{navHover.text}</Link>
                          </li>
          ...
          <ul className={styles["nav-links-active"]}>
            ...
            <li className={styles["nav-items-active"]}>
              ...
              <div className={`${styles["about-expand"]} ${styles.active}`}>
                ...
                <div className={styles["about-link"]}>
                  <Link href="/activity">Our Activity</Link>
                </div>
                <div className={styles["about-link"]}>
